...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/logos/kitab1.png') }}" />
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="#" class="text-nowrap logo-img text-center d-block py-1 w-100">
                                    <img src="{{ asset('assets/images/logos/ikon2.png') }}" alt="Market Logo"
                                        width="35%" />
                                </a>
                                <!-- <p class="text-center">The Best Market</p> -->
